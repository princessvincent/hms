...
<div class="col-md-8">
        ...
        @endif
                    ...
                    <div class="card">
                        <div class="card-header">{{ __('Update Meal Rate ') }}</div>

                        <div class="card-body">
                                <form method="put" action='{{url("updatera/" .$rate->id)}}'>
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="nameof_meal" type="text" class="form-control @error('nameof_meal') is-invalid @enderror"
                                            name="nameof_meal" value="{{ $rate->nameof_meal }}" required autocomplete="nameof_meal" autofocus>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="rate" type="text"
                                            ...
                                            value="{{ $rate->rate }}" required autocomplete="rate">
