...
<div class="col-md-8">
        ...
        @endif
                    ...
                    <div class="card">
                        <div class="card-header">{{ __('Update Blocks Info') }}</div>

                        <div class="card-body">
                              <form method="put" action='{{url("updatebloc/" .$block->id)}}'>
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="block_no" type="text" class="form-control @error('block_no') is-invalid @enderror"
                                            name="block_no" value="{{  $block->block_no }}" required autocomplete="block_no" autofocus>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="block_name" type="text"
                                            ...
                                            value="{{  $block->block_name }}" required autocomplete="block_name">
                                    ...
                                    <div class="col-md-6">
                                        <input id="description" type="text"
                                            class="form-control @error('description') is-invalid @enderror" name="description"
                                             value="{{  $block->description }}" required autocomplete="description">
