...
@extends((!isset(Auth::user()->id))? 'layouts.app': ((Auth::user()->role_as == 1) ? 'layouts.head' : 'layouts.header')) 
  ...
  <div>
                    ...
                    <div class="card">
                        <div class="card-header">{{ __('Add Rooms Information') }}</div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="room_no" type="text" class="form-control @error('room_no') is-invalid @enderror"
                                            name="room_no" value="{{ old('room_no') }}" required autocomplete="room_no" autofocus>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="block_no" type="text"
                                            ...
                                            value="{{ old('block_no') }}" required autocomplete="block_no">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="noOfseat" type="text"
                                            ...
                                            required autocomplete="new-noOfseat">
