            ...
            <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action='{{ url('updatestu/' . $student->id) }}' enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="fullname" type="text"
                                        ...
                                        value="{{ $student->fullname }}" required autocomplete="fullname" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="phone_num" type="number"
                                        ...
                                        value="{{ $student->phone_num }}" required autocomplete="phone_num">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="password" type="password"
                                        ...
                                        value="{{ $student->password }}" required autocomplete="password">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="nameof_insti" type="text"
                                        ...
                                        value="{{ $student->nameof_insti }}" required autocomplete="nameof_insti">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="program" type="text"
                                        ...
                                        value="{{ $student->program }}" required autocomplete="program">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="batch_no" type="text"
                                        ...
                                        value="{{ $student->batch_no }}" required autocomplete="batch_no">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="nationality" type="text"
                                        ...
                                        value="{{ $student->nationality }}" required autocomplete="nationality">
                            ...
                            <div class="row mb-3">
                                <label for="nation id"
                                    class="col-md-4 col-form-label text-md-end">{{ __('National Identification Number') }}</label>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="passport_no" type="text"
                                        ...
                                        value="{{ $student->passport_no }}" autocomplete="passport_no">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="father_num" type="number"
                                        ...
                                        value="{{ $student->father_num }}" required autocomplete="father_num">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="mother_num" type="number"
                                        ...
                                        value="{{ $student->mother_num }}" required autocomplete="mother_num">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="local_guardian" type="text"
                                        ...
                                        name="local_guardian" value="{{ $student->local_guardian }}" required
                                        autocomplete="local_guardian">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="guardian_num" type="number"
                                        ...
                                        name="guardian_num" value="{{ $student->guardian_num }}" required
                                        autocomplete="guardian_num">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="present_address" type="text"
                                        ...
                                        name="present_address" value="{{ $student->present_address }}" required
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="permanent_address" type="text"
                                        ...
                                        name="permanent_address" value="{{ $student->permanent_address }}" required
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img src="{{ asset('uploads/student/' . $student->profile_image) }}" width='50'height='50' class="img img-responsive" />
                                </div>
                            </div>
