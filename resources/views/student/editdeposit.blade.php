...
<div class="col-md-8">
        ...
        @endif
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="put" action='{{url("updated/" .$depo->id)}}'>
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="student_name" type="text" class="form-control @error('student_name') is-invalid @enderror"
                                            name="student_name" value="{{  $depo->student_name }}" required autocomplete="student_name" autofocus>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="amount" type="text"
                                            ...
                                            value="{{ $depo->amount}}" required autocomplete="amount">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="deposit_date" type="date"
                                          ...
                                          value="{{ $depo->deposit_date}}"  required autocomplete="deposit_date">
