...
@section('content')
  ...
  <div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route("studentpay") }}">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="payment_date" type="date" class="form-control @error('payment_date') is-invalid @enderror"
                                        name="payment_date" value="{{ old('payment_date') }}" required autocomplete="payment_date">
                           ...
                           <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="transaction_num" type="number"
                                        ...
                                        required autocomplete="transaction_num">
