        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    ...
                    <div class="card">
                        <div class="card-header">{{ __('Student Attendance') }}</div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="attend_date" type="date"
                                            ...
                                            name="attend_date" value="{{ old('attend_date') }}" required
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="isAbsence" type="text"
                                            ...
                                            value="{{ old('isAbsence') }}" required autocomplete="isAbsence">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="isleave" type="text"
                                            ...
                                            required autocomplete="new-isleave">
