    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card">
                    <div class="card-header">{{ __('Add Employee Info') }}</div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="employ_type" type="text"
                                        ...
                                        value="{{ old('employ_type') }}" required autocomplete="employ_type">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="dob" type="date" class="form-control @error('dob') is-invalid @enderror"
                                        name="dob" required autocomplete="new-dob">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="doj" type="date" class="form-control @error('doj') is-invalid @enderror"
                                        name="doj" required autocomplete="doj">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="block_no" type="text"
                                        ...
                                        required autocomplete="block_no">
