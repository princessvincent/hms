...
<div>
        ...
        @endif
                ...
                <div class="card">
                    <div class="card-header">{{ __('Update Salary') }}</div>

                    <div class="card-body">
                        <form method="put" action='{{url("updatesa/" .$salary->id)}}'>
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="employ_name" type="text"
                                        ...
                                        value="{{ $salary->employ_name }}" required autocomplete="employ_name" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="monthYear_paid" type="text"
                                        ...
                                        name="monthYear_paid" value="{{ $salary->monthYear_paid }}" required
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="amount" type="text"
                                      ...
                                      value="{{ $salary->amount }}"  autocomplete="new-amount">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="paid_date" type="date"
                                      ...
                                      value="{{ $salary->paid_date }}"  required autocomplete="paid_date">
